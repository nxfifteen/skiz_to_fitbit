    ...
    <div class="col-12 col-md-8">
        <div class="card card-inverse card-success">
            ...
            <div class="card-footer">
                ...
                <a href="<?php echo $receiver->getDownloadPath(); ?>" class="btn btn-sm btn-primary pull-right">
                    Download TCX ZIP Files </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-inverse card-info" id="stageProg">
                    ...
                    <div class="card-block">
                        ...
                        Description:
                        <strong><?php echo ucwords($tracksFile[ '@attributes' ][ 'description' ]); ?></strong><br/>
                        Activity:
                        <strong><?php echo ucwords($tracksFile[ '@attributes' ][ 'activity' ]); ?></strong><br/>
                        Conditions:
                        <strong><?php echo ucwords($tracksFile[ '@attributes' ][ 'conditions' ]); ?></strong><br/>
                        Weather: <strong><?php echo ucwords($tracksFile[ '@attributes' ][ 'weather' ]); ?></strong><br/>
                        TimeZone, GMT Offset: <?php echo $receiver->getTimezoneName() ?>
                        (<?php echo $receiver->getTimezoneOffset() ?>)<br/>

                        <hr/>
                        Total Descent Distance:
                        <strong><?php echo number_format($tracksFile[ 'metrics' ][ 'descentdistance' ] * 0.001, 2); ?>
                            km</strong><br/>
                        Total Ascent Distance:
                        <strong><?php echo number_format($tracksFile[ 'metrics' ][ 'ascentdistance' ] * 0.001, 2); ?>
                            km</strong><br/>
                        Average Descent Speed:
                        <strong><?php echo number_format($tracksFile[ 'metrics' ][ 'averagedescentspeed' ] * 3.6, 2); ?>
                            kph</strong><br/>
                        Max Descent Speed:
                        <strong><?php echo number_format($tracksFile[ 'metrics' ][ 'maxdescentspeed' ] * 3.6, 2); ?>
                            kph</strong>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-inverse card-danger" id="stageProg">
                    ...
                    <div class="card-block">
                        <p>I've become aware some browsers - mainly Firefox & Chrome - are blocking downloaded ZIP files
                            from this site as the file is not commonly downloaded.</p>
                        <p>If your TCX ZIP file doesn't download as you expect, its worth checking your browsers
                            download manager and see if its 'holding' the file waiting on your approval</p>
                    </div>
                </div>
            </div>
        </div>
